...
Deep learning is a branch of ML which opts for huge expressive power, but losing almost all interpretability in the process. For this project we will be exploring neural networks, mathematical structures which can (approximately) represent any function. Neural networks allow us to discover complex patterns in data that other models might not be able to predict.
